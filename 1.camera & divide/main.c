...
int main()
{
    ...
    fileE = fopen("../data/count.md","w");
    fileER = fopen("../data/countR.md","w");
    fileEG = fopen("../data/countG.md","w");
    fileEB = fopen("../data/countB.md","w");
    fclose(fileE);
    fclose(fileER);
    fclose(fileEG);
    fclose(fileEB);
...
// core block;
        //R;
            ...
            fileE = fopen("../data/count.md","a");
            fileER = fopen("../data/countR.md","a");
...
//open new original file;
    ...
    printf("all steps has been completed ,please put anykey then input enter\n");
    getchar();
    return 0;
}
